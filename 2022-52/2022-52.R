...
tlBooks %>% 
  ...
  theme(
    ...
    plot.title = element_markdown(family = title_font, size = 36, face = 'bold', margin = margin(b = 7)),
    plot.subtitle = element_markdown(family = title_font, size = 15, margin = margin(b = 20)),
